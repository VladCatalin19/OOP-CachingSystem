...
public interface Cache<K, V> {
    ...
    /**
     * Get the value associated with a key, or null if the key does not exist in
     * the cache.
     *
     * @param key
     *            the key
     ...
     * @return the value associated with the key, or null if the key was not in
     *         the cache
     */
    V remove(K key);
    ...
    /**
     * Return the eldest entry from the cache. The definition for the eldest
     * entry varies from one type of cache to another.
     *
